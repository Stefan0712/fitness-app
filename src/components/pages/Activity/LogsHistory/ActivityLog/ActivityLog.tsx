        ...
        <div className={styles.activityLog}>
            ...
            <div className={styles.content}>
                ...
                <div className={styles.logContent}>
                    <p className={styles.timestamp}>On {getDateFromTimestamp(logData.timestamp)} at {getHourFromTimestamp(logData.timestamp)} {logData.duration ? `for ${logData.duration} minutes` : ''}</p>
